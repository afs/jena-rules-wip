...
class DevVersion0 {
    ...
    public static void execute0(RuleSet rules, Graph baseGraph) {
        ...
        if ( true ) {
            ...
            System.out.println("#0# Total graph");
        ...
        System.out.println("#0# Final graph [rounds="+round+"]");
        RDFWriter.source(graph).format(RDFFormat.TURTLE_FLAT).output(System.out);
        System.out.println();
        System.out.println("------------------");
    }
