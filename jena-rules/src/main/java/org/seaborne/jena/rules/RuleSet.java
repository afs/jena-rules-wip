...
public class RuleSet implements Iterable<Rule>{
    ...
    public static class Builder {
        ...
        private PrefixMap pmap = null;

        public Builder() {}

        public Builder set(PrefixMap pmap) {
            this.pmap = pmap;
            return this;
        }
        ...
        public RuleSet build() {
            ...
            return new RuleSet(rules, Renamer.rename("v", rules), pmap);
        }
    }
...
//    }
    ...
    private RuleSet(List<Rule> rules, List<Rule> execRules, PrefixMap pmap) {
        this.rules = rules;
