...
package org.seaborne.jena.inf_rdfs.tdb ;
...
import org.seaborne.jena.inf_rdfs.engine.BaseInfSetupRDFS;

/** RDFS setup in NodeId space (TDB2) */
public class InfSetupRDFS_TDB2 extends BaseInfSetupRDFS<NodeId>{
    private final DatasetGraphTDB dsgtdb ;
    private final NodeTable nodetable ;

    public InfSetupRDFS_TDB2(Graph vocab, DatasetGraph dsg) {
        this(vocab, dsg, false) ;
    }

    public InfSetupRDFS_TDB2(Graph vocab, DatasetGraph dsg, boolean incDerivedDataRDFS) {
